								...
								<?php if( have_rows('social_media') ): ?>
									<?php while( have_rows('social_media') ): the_row(); ?>
										<span class="elementor-grid-item">
											<a class="elementor-icon elementor-social-icon elementor-social-icon-facebook-square elementor-animation-sink elementor-repeater-item-d258a42"
												href="<?php echo get_sub_field('link'); ?>" target="_blank">
						...
						<div class="elementor-element elementor-element-3423b80 elementor-hidden-desktop elementor-hidden-tablet elementor-shape-rounded elementor-grid-0 e-grid-align-center elementor-widget elementor-widget-social-icons"
							...
							<div class="elementor-widget-container">
								<div class="elementor-social-icons-wrapper elementor-grid">
									...
									<?php while( have_rows('social_media') ): the_row(); ?>
										<span class="elementor-grid-item">
											<a class="elementor-icon elementor-social-icon elementor-social-icon-facebook-square elementor-animation-sink elementor-repeater-item-d258a42" href="<?php echo get_sub_field('link'); ?>" target="_blank">
												<span class="elementor-screen-only"></span>
												<?php echo get_sub_field('icon'); ?>
											 </a>
										</span>
